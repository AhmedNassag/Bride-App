                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="{{url('makeupArtist-show/'.$row->id)}}" style="color: #1f1f1f">{{$row->name}}</a></td>
                                ...
                                <td class="text-center">
                                    <a href="{{url('makeupArtist-edit/'.$row->id)}}" class="btn btn-info btn-sm">EDIT</a>
                                    <button type="button" class="btn btn-danger btn-sm makeupArtistDeleteBtn">DELETE</button>
                                    @if($row->status == 1)
                                    <a style="margin: 5px 0" href="{{url('makeupArtist-change/'.$row->id)}}" class="btn btn-adn btn-sm"><i class="fa fa-times-circle"></i>Block</a>
                                    @else
                                    <a style="margin: 5px 0" href="{{url('makeupArtist-change/'.$row->id)}}" class="btn btn-success btn-sm"><i class="fa fa-check"></i>Active</a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
