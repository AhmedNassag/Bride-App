                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            @php $i++; @endphp
                                <tr>
                                    <input type="hidden" class="makeupArtistDelBtn" value="{{$row->id}}">
                                    <td>{{$i}}</td>
                                    <td>{{$row->name}}</td>
                                    <td>{{$row->phone}}</td>
                                    <td>
                                    ...
                                    <td>{{$row->email}}</td>
                                    <td>
                                        <a href="{{url('makeupArtist-edit/'.$row->id)}}" class="btn btn-info">EDIT</a>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-danger makeupArtistDeleteBtn">DELETE</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
